...
export async function POST() {
  ...
  try {
    ...
    results.rss = { ok: false, error: String((err as any)?.message ?? err) };
  }
  ...
  try {
    ...
    results.arxiv = { ok: false, error: String((err as any)?.message ?? err) };
  }
  ...
  try {
    ...
    results.github = { ok: false, error: String((err as any)?.message ?? err) };
  }
  ...
  try {
    ...
    results.youtube = { ok: false, error: String((err as any)?.message ?? err) };
  }
  ...
  try {
    ...
    results.web = { ok: false, error: String((err as any)?.message ?? err) };
  }
